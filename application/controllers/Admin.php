...
class Admin extends CI_Controller {
    ...
    public function index()
    {
        ...
        $userInfo = $this->adminmodel->getUserInfo();
    ...
    public function changePassword()
    {
        ...
        $checkExists = $this->adminmodel->checkOldPassword($userid, $oldPassword);
        if (!$checkExists) {
            $data["isError"] = TRUE;
        ...
        if ($oldPassword !== $newPassword){
            $this->adminmodel->passwordUpdate($userid, $newPassword);
            $data["isError"] = FALSE;
    ...
    public function deletePurchaseRecord()
    {
        ...
        $this->adminmodel->deletePurchaseRecord($recordId, $tableName);
    ...
    public function deleteRetentionMoneyRecord()
    {
        ...
        $this->adminmodel->deleteRetentionMoneyRecord($recordId);
    ...
    public function deletePartyPaymentRecord()
    {
        ...
        $this->adminmodel->deletePartyPaymentRecord($partyPaymentId, $partyPaymentTable, $partyPaymentReceivedId, $partyPaymentReceivedTable);
    ...
    public function completePurchaseRecord()
    {
        ...
        $this->adminmodel->completePurchaseRecord($recordId, $tableName);
    ...
    public function deleteLeaveRecord()
    {
        ...
        $this->adminmodel->deleteLeaveRecord($recordId);
    ...
    public function changeAllEmployeeStatus()
    {
        ...
        $this->adminmodel->allEmployeeStatusChange($recordId, $statusValue);
    ...
    public function permission_list($pageStatus='')
    {
        ...
        if (in_array('admin', $userPermission) || in_array('employee_management', $userPermission)) {
            ...
            $data['permissionList'] = $this->adminmodel->getPermissionList($pageStatus);
    ...
    public function permission_edit($permissionId)
    {
        ...
        if (in_array('admin', $userPermission) || in_array('employee_management', $userPermission)) {
            ...
            $permissionInfo = $this->adminmodel->getPermissionInfo($permissionId);
    ...
    public function permissionFormSave() {
        ...
        if (empty($permissionId)) {
            $checkExists = $this->adminmodel->checkLoginCode($token, $mobileNumber);
            if ($checkExists > 0) {
                $data["isError"] = TRUE;
        ...
        $this->adminmodel->savePermissionData($permissionId, $token, $loginCode, $name, $mobileNumber, $password, $permissionsString, $status);
    ...
    public function file_manage_list($pageStatus='')
    {
        ...
        if (in_array('admin', $userPermission)) {
            ...
            $data['fileManageList'] = $this->adminmodel->getFileManageList($pageStatus);
    ...
    public function file_manage_edit($fileManageId)
    {
        ...
        if (in_array('admin', $userPermission)) {
            ...
            $fileManageInfo = $this->adminmodel->getFileManageInfo($fileManageId);
    ...
    public function fileManageFormSave()
    {
        ...
        $this->adminmodel->saveFileManageData($fileManageId, $fileName, $fileURL, $fileDoc_img, $remarks);
    ...
    public function event_list($year = '')
    {
      ...
      if (in_array('admin', $userPermission)) {
        ...
        $data['monthEventList'] = $this->adminmodel->getMonthEventList($year);
    ...
    public function event_edit($eventId)
    {
      ...
      if (in_array('admin', $userPermission)) {
        ...
        $yearlyPlanDetail = $this->adminmodel->getYearlyPlanInfo($eventId);
    ...
    public function event_view($year = '', $month = '')
    {
      ...
      if (in_array('admin', $userPermission)) {
        ...
        $data["year"] = $year;
        $data["month"] = $month;
        $data['yearlyPlanList'] = $this->adminmodel->getYearlyPlanList($year, $month);
    ...
    public function yearlyPlanFormSave()
    {
      ...
      $this->adminmodel->saveYearlyPlanData($eventId, $date, $title, $description, $status, $planType);
    ...
    public function branch_visit_list()
    {
      ...
      if (in_array('admin', $userPermission)) {
        ...
        $data['branchRecentVisitList'] = $this->adminmodel->getBranchRecentVisitList();
    ...
    public function branch_visit_edit($visitId)
    {
      ...
      if (in_array('admin', $userPermission)) {
        ...
        $branchVisitDetail = $this->adminmodel->getBranchVisitInfo($visitId);
    ...
    public function branch_visit_view($branchId = '')
    {
      ...
      if (in_array('admin', $userPermission)) {
        ...
        $data["branchId"] = $branchId;
        $data['branchVisitList'] = $this->adminmodel->getBranchVisitList($branchId);
    ...
    public function addBranchVisitFormSave()
    {
      ...
      $this->adminmodel->saveAddBranchVisitData($branchVisitId, $visitDate, $branchId, $branchVisitArrayData);
    ...
    public function editBranchVisitFormSave()
    {
      ...
      $this->adminmodel->saveEditBranchVisitData($branchVisitId, $visitDate, $branchId, $visitTitle, $visitRemark, $visitStatus);
