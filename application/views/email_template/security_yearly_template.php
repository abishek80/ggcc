...
<head>
    <meta charset="utf-8">
    <title>Yearly Security Amount Reminder</title>
    <style>
...
<body>
    <div class="container">
        <h2>Yearly Security Amount Reminder - <?php echo $year; ?></h2>
        <p>Hello,</p>
        <p>Below is the overall list of pending security amounts that are due this year.</p>
        ...
        <?php if (!empty($groupedSecurity)) { ?>
            ...
            <?php } ?>
        <?php } else { ?>
            <p>No pending security amounts found for this year.</p>
        <?php } ?>
