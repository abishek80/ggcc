<section class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <form id="thirdpartyloanReceivedForm" method="post" class="card px-3 pb-3">
            ...
            <input name="loan_received_id" id="loan_received_id" type="hidden" value="<?php echo $thirdpartyloanReceivedId; ?>">
            <div class="row g-3">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <input name="thirdparty_remarks" id="thirdparty_remarks" readonly type="text" class="employeeRemarks form-control" placeholder="Thirdparty Remarks" value="<?php echo $thirdpartyRemarks; ?>">
                </div>
                <div class="col-lg-3 col-md-6">
                ...
                <div class="col-lg-3 col-md-6">
                    <label class="w-100 fw-bold text-black mb-2 fs-14px">Loan Received Amount <span class="text-danger">*</span></label>
                    <input name="received_amount" id="received_amount" type="text" class="form-control number-only" placeholder="Loan Received Amount" value="<?php echo $receivedAmount; ?>">
                </div>
            </div>
        </form>
    </div>
...
<script>
    ...
    // Thirdparty Payslip Save Function
    $("#thirdpartyloanReceivedForm").validate({
        rules: {
            thirdparty_name: {
                required: true
            },
        ...
        messages: {
            ...
            received_date: {
                required: "Please Select Loan Received Date"
            },
            received_amount: {
                required: "Please Enter Loan Received Amount"
            }
        },
        submitHandler: function (form) {
            var data = new FormData($('#thirdpartyloanReceivedForm').get(0));
            $.ajax({
                url: '<?php echo base_url(); ?>loan/thirdpartyloanReceivedFormSave',
                data: data,
                cache: false,
                processData: false,
                contentType: false,
