    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex flex-wrap gap-2 gap-md-3 mb-3">
            <?php foreach ($yearList as $year) { ?>
                <a href="<?php echo base_url(); ?>event-list/<?php echo $year; ?>" class="<?php echo ($activeLink == $year) ? 'bg-primary text-white' : 'bg-white text-primary'; ?> px-4 py-2 px-md-5 shadow shadow-sm fw-bold lh-1 rounded-2 border-primary border border-3 border-end-0 border-start-0 border-top-0"><?php echo $year; ?></a>
            <?php } ?>
        </div>
        <div class="card p-3">
            <div class="d-flex justify-content-between align-items-center">
                <h4 class="fw-bold mb-0 text-black">Yearly Plan List</h4>
                <a href="<?php echo base_url() . 'event-add/' . $activeLink; ?>" class="btn btn-primary px-4 py-2 rounded text-white">Add Yearly Plan</a>
            </div>
        </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 text-center">
                        <div class="d-block bg-white card p-3">
                            ...
                            <div class="d-flex gap-3 justify-content-between align-items-center">
                                ...
                                <a href="<?php echo base_url() . 'event-view/' . $row->year . '/' . $row->month; ?>">
                                    <div class="d-flex justify-content-center align-items-center">
...
<script>
    $(document).on("click", ".getEventId", function(e){
        ...
        $.ajax({
            ...
            url: '<?php echo base_url(); ?>getYearlyPlanDetail',
            dataType: "json",
            data: {year, month},
