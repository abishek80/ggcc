        ...
        <div class="layout-container">
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul id="ggccMenu" class="menu-inner py-1">
                    ...
                    <?php if($checkEmployeeAttendanceList && $this->session->userdata('is_admin') == '0') { ?>
                    ...
                    <?php } ?>
                    <?php if($checkEmployeeExpensesList && $this->session->userdata('is_admin') == '0') { ?>
                    ...
                    <?php } ?>
                    <?php if($employeeComplaintList && $this->session->userdata('is_admin') == '0') { ?>
                    ...
                    <?php } ?>
                    <?php if(in_array('admin', $userPermission) || in_array('employee_management', $userPermission) || in_array('vehicle_management', $userPermission)) { ?>
                    ...
                    <?php } ?>
                    <?php if(in_array('admin', $userPermission) || in_array('stock_management', $userPermission) || in_array('purchase_management', $userPermission) || in_array('account_management', $userPermission) || in_array('employee_management', $userPermission) || in_array('complaint_management', $userPermission)) { ?>
