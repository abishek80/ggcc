                        ...
                        <form id="taxinvoiceForm" method="post" class="mt-3 row g-3 taxinvoiceForm d-none">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="d-flex gap-3 justify-content-end h-100 align-items-end">
                                    <a href="<?php echo base_url() . 'purchase/taxinvoice-list/' . $companyName; ?>" class="btn btn-danger px-4 py-2 rounded border-0 fw-bold text-white">Cancel</a>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data['isError']) {
                        ...
                        setTimeout(function () {
                            window.location.href = "<?php echo base_url() . 'purchase/taxinvoice-list/' . $companyName; ?>";
                        }, 1500);
                    }
                }
            });
