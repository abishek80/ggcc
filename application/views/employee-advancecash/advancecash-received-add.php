<section class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <form id="advancecashReceivedForm" method="post" class="card px-3 pb-3">
            ...
            <input name="advancecash_received_id" id="advancecash_received_id" type="hidden" value="<?php echo $advancecashReceivedId; ?>">
            <div class="row g-3">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <input name="received_amount" id="received_amount" type="text" class="form-control number-only" placeholder="Enter Loan Received Amount" value="<?php echo $receivedAmount; ?>">
                </div>
            </div>
        </form>
    </div>
...
<script>
    ...
    $("#advancecashReceivedForm").validate({
        rules: {
            employee_name: {
                required: true
            },
            receivedAdvancecash_date: {
                required: true
            },
            receivedAdvancecash_amount: {
                required: true
            }
        },
        messages: {
        ...
        submitHandler: function (form) {
            var data = new FormData($('#advancecashReceivedForm').get(0));
            $.ajax({
                url: '<?php echo base_url(); ?>loan/advancecashReceivedFormSave',
                data: data,
                cache: false,
                processData: false,
                contentType: false,
